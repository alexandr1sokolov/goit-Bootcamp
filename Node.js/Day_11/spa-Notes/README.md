...
### План Занятия
 ...
 - MongoDB, взаимодействие с базой данных
...
В рамках данного урока мы напишем небольшое приложение для создания и хранения заметок на NodeJS, Express, MongoDB и React.
...
Здесь мы создали express-приложение и запустили веб-сервер на порте 8080. Для того, чтобы запустить его нужно выполнить в терминале `node app.js`.

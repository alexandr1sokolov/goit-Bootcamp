...
Вы уже научились структурировать Node.js-проекты, поэтому давайте использовать эти знания!
...
*(Вы можете скачать исходный код по [ссылке](https://github.com/NadyaHristuk/Node.js/tree/master/Day_2/chapter8/node-authentication))*
...
Мы будем использовать Express для серверной среды. 
